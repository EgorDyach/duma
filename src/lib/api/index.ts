...
export const requestGroupLessons = async (
  id: string | number | undefined): Promise<any> => {
  return await request.get(`https://puzzlesignlanguage.ru/api/back/v1/group/${id}/lessons`, {});
};

export const requestTeacherLessons = async (): Promise<any> => {
  return await request.get(`https://puzzlesignlanguage.ru/api/back/v1/teacher/lessons`, {});
};
